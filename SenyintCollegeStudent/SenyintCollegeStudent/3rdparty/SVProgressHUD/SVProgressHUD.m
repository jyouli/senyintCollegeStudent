...
+ (void)showInfoWithStatus:(NSString *)string duration:(NSTimeInterval)duration {
    [self sharedView];
    [self showInfoWithStatus:string duration:duration maskType:SVProgressHUDDefaultMaskType];
}
...
+ (void)showInfoWithStatus:(NSString *)string duration:(NSTimeInterval)duration maskType:(SVProgressHUDMaskType)maskType {
    [self sharedView];
    [self showImage:SVProgressHUDInfoImage status:string duration:duration maskType:maskType];
}
...
+ (void)showSuccessWithStatus:(NSString *)string duration:(NSTimeInterval)duration {
    [self sharedView];
    [self showSuccessWithStatus:string duration:duration maskType:SVProgressHUDDefaultMaskType];
}
...
+ (void)showSuccessWithStatus:(NSString *)string duration:(NSTimeInterval)duration maskType:(SVProgressHUDMaskType)maskType {
    [self sharedView];
    [self showImage:SVProgressHUDSuccessImage status:string duration:duration maskType:maskType];
}
...
+ (void)showErrorWithStatus:(NSString *)string duration:(NSTimeInterval)duration {
    [self sharedView];
    [self showErrorWithStatus:string duration:duration maskType:SVProgressHUDDefaultMaskType];
}
...
+ (void)showErrorWithStatus:(NSString *)string duration:(NSTimeInterval)duration maskType:(SVProgressHUDMaskType)maskType {
    [self sharedView];
    [self showImage:SVProgressHUDErrorImage status:string duration:duration maskType:maskType];
}
